...
wis.widget.Input.prototype = {
    ...
    _format:null,					//格式化
    _value: null,                   //本框的值
    _type: 'text',					//类型，如“text”，和html类型一致
     ...
     */
    initRender: function () {
    	this._rootObj = $('<input type="'+this.getType()+'"/>');
