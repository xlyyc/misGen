...
var CodeMirror = (function () {
    ...
    CodeMirror.fromTextArea = function (textarea, options) {
        ...
        if (options.theme) {
            ...
            css.setAttribute("href", easyloader.URI + "/js/plugins/codemirror/theme/" + options.theme + ".css");
...
var valueToTextArea = function(obj) {
    var textarea;
    if(typeof obj == "object"){
        textarea = obj;
    }else if(typeof obj == "string"){
        textarea = findTextArea(obj);
    }else{
        return;
    }
    var instance = textarea.nextSibling.CodeMirror;
    textarea.value = instance.getValue();
};
//查找节点
var findTextArea = function(id){
    var _id = "#"+id;
    var iframes = top.frames;
    for(var i=1,len=iframes.length;i<len;i++){
        var _textArea = $(iframes[i].document).find(_id);
