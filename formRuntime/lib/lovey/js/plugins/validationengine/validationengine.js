...
(function ($) {
    $.fn.validationEngine = function (settings) {
        ...
        if ($.validationEngineLanguage) {                // IS THERE A LANGUAGE LOCALISATION ?
            ...
            if(settings && settings.allRules && typeof settings.allRules == "object")
            {
        ...
        validateCall: function (caller, rules) {    // EXECUTE VALIDATION REQUIRED BY THE USER FOR THIS FIELD
            ...
            function _required(caller, rules) {   // VALIDATE BLANK FIELD
                ...
                if (callerType == "text" || callerType == "password" || callerType == "textarea" || callerType == "file") {
                    ...
                    if (!value) {
                        ...
                        promptText += $.validationEngineLanguage.getAlertText(caller,rules[i],"alertText") + "<br />";
                    }
                }
                if (callerType == "radio" || callerType == "checkbox") {
                    ...
                    if ($("input[name='" + callerName + "']:checked").size() == 0) {
                        ...
                        if ($("input[name='" + callerName + "']").size() == 1) {
                            promptText += $.validationEngineLanguage.getAlertText(caller,rules[i],"alertTextCheckboxe") + "<br />";
                        } else {
                            promptText += $.validationEngineLanguage.getAlertText(caller,rules[i],"alertTextCheckboxMultiple") + "<br />";
                        }
                    }
                }
            ...
            function _customRegex(caller, rules, position) {         // VALIDATE REGEX RULES
                ...
                if (!pattern.test($(caller).attr('value'))) {
                    $.validationEngine.isError = true;
                    promptText += $.validationEngineLanguage.getAlertText(caller,customRule,"alertText") + "<br />";
                }
            }
            ...
            function _exemptString(caller, rules, position) {         // VALIDATE REGEX RULES
                ...
                if (customString == $(caller).attr('value')) {
                    ...
                    promptText += $.validationEngineLanguage.getAlertText(caller,"required","alertText") + "<br />";
                }
            }
                ...
                if (ajaxed) {
                    ...
                    if (!callerElement.hasClass("success_bg")) {
                        if (formError[0]) {
                            ...
                            else if( callerElement.parent().parent().hasClass("l-text-combobox"))
                            {
                                callerElement.parents(".l-text-combobox:first").addClass("error_bg");
                                callerElement.removeClass("error_bg");
                            }
                        } else {
                            //失败执行
                            ...
                            else if(callerElement.hasClass("l-text-field"))
                            {
                                callerElement.parents(".l-text-combobox:first").removeClass("error_bg");
                            }
                        ...
                        if (formError[0]) {
                            ...
                            else if(callerElement.parents(".l-text-combobox:first").hasClass("error_bg"))
                            {
                                callerElement.parents(".l-text-combobox:first").preview({
                                    caller: callerElement,
                                    validate: true,
                                    formErrorContent: $(".formErrorContent", formError)
                                });
                            ...
                            callerElement.parents(".l-text-combobox:first").unbind("hover");
                        }
...
(function ($) {
    ...
    $.validationEngineLanguage = {
        ...
        getAlertText:function(caller,rule,strName){
            if($(caller).attr(rule+"_"+strName))
            {
                return $(caller).attr(rule+"_"+strName)
            }
            else
            {
                return $.validationEngine.settings.allrules[rule][strName];
            }
        }
    }
})(jQuery);
