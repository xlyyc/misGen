...
(function ($) {
    ...
    $.ligerSelect.submit = function (dialog, p, element) {
        ...
        (typeof p.resualtFunction == "function") && p.resualtFunction({backValue: backHiddenValue,backValueStr:backValueStr,backHiddenElement:element.next()});
        dialog.close();
        ...
        this.each(function () {
            ...
            if (this.tagName.toLowerCase() == "input" || this.tagName.toLowerCase() == "textarea" || this.tagName.toLowerCase() == "div") {
                ...
                if (p.initJson) {
                    ...
                    (typeof p.resualtFunction == "function") && p.resualtFunction({backValue: backHiddenValue,backValueStr:backValue,backHiddenElement: $(this).next()});
