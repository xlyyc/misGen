...
if (window.jQuery && !window.jQuery.createTemplate) {
    (function (jQuery) {
        ...
        jQuery.fn.processTemplate = function (d, param, options) {
            $.processTemplate(d, param, options, '');
        };

        jQuery.fn.processTemplate = function (d, param, options, insert) {
            return jQuery(this).each(function () {
                var t = jQuery.getTemplate(this);
                if (t === undefined) {
                    if (Template.DEBUG_MODE)
                ...
                } else if (insert.toLowerCase() == 'prepend') {
                    //jQuery(this).prepend(t.get(d, param, jQuery.extend(true, {}, this), 0));
                    jQuery(this).prepend(t.get(d, param, this, 0));
                } else if (insert.toLowerCase() == 'append') {
                    //jQuery(this).append(t.get(d, param, jQuery.extend(true, {}, this), 0));
                    jQuery(this).append(t.get(d, param, this, 0));
                } else if (insert.toLowerCase() == 'after') {
                    //jQuery(this).after(t.get(d, param, jQuery.extend(true, {}, this), 0));
                    jQuery(this).after(t.get(d, param, this, 0));
                } else if (insert.toLowerCase() == 'before') {
                    //jQuery(this).before(t.get(d, param, jQuery.extend(true, {}, this), 0));
                    jQuery(this).before(t.get(d, param, this, 0));
                }
            });
        };
         ...
         * @memberOf jQuery.fn
         */
        jQuery.fn.processTemplateURL = function (url_, param, options, insert) {
            var that = this;
            ...
            jQuery.ajax({
                ...
                dataType: 'text',
                success: function (d) {
                    var r = jQuery(that).processTemplate(d, param, {StrToJSON: true}, insert);
                    if (o.on_success) {
                        o.on_success(r);
                    }
                },
        ...
        jQuery.extend(/** @scope jQuery.prototype */{
             ...
             * @param {Boolean} value
             */
            jTemplatesFireMode: function (value) {
                var DEFAULT = true;
                if (value = undefined) {
                    value = true;
                }

                Template.FIRE_HTML = value;
            }
