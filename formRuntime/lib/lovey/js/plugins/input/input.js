(function($) {
	...
	$.loveyInput.create = function(option) {
		var input = {
			_option: {},
			_render: function() {
				...
				if (this._option.maxlength) this.root.attr('maxlength', this._option.maxlength);
			...
			init: function(option) {
				this.root = $('<input type="text"/>');
				$.extend(this._option, $.loveyInput.Default, option);
