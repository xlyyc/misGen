                ...
                if (p.allowAdjustColWidth) {
                    g.gridheader.mousemove(
                        function (e) {
                            ...
                            if ($(e.target).hasClass("l-grid-hd-cell-checkbox")) return;

                            var isSide = false;
                            var deviation = [];
                            var distance = e.clientX - Math.ceil((e.target.clientWidth + $(e.target).offset().left));
                            if (navigator.userAgent.indexOf("Firefox") != -1) {

                                deviation = [-1, 0, 1];
                                isSide = ($.inArray(distance, deviation) >= 0);
                            }
                                ...
                                isSide = (e.target.clientWidth + $(e.target).offset().left == e.clientX);
                            }

                            //判断是否经过了边界
                            if (isSide) {
                                g.toDragHeaderIndex = $(e.target).parent().children().index(e.target);
...
//                            }
                        ...
                        if (g.columns[this.columnindex].frozen) {
                            console.log(i);
                            console.log(gridtdhtmlarr.join(""));
            ...
            setHeight: function (h) {
                ...
                {
                    g.gridbody.height(h);
					g.gridview.height(g.gridview2.outerHeight());
                    if( g.gridbody.css("overflow-x") == "auto")
                    {
                        g.gridbody1.height(g.gridbody.height() - 18);
                    }
                    else
                    {
               ...
               /* if (p.title) h -= 24;
                ...
                if (h > 0) {
                    ...
                    g.gridview.height(h + p.headerRowHeight);
                }*/
            },
            /**
             *
            ...
            rebuildWidth: function () {
                ...
                if($(".l-grid2 .l-grid-body",$(grid)).width() == $(".l-grid2 .l-grid-body>.l-grid-body-inner>.l-grid-body-table",$(grid)).width())
                {
                    $(".l-grid2 .l-grid-body",$(grid)).css("overflow-x","hidden");
                }
                else
                {
                    $(".l-grid2 .l-grid-body",$(grid)).css("overflow-x","auto");
                }
                //同步浮动列高度
