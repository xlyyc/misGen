...
*
 *  @update：将导致样式冲突的类名加一个后缀spinner  by 宋士杰 sjsong01@wisedu.com   2013-07-08
*/
(function($)
{
    ...
    $.fn.ligerSpinner = function(p)
    {
        return this.each(function()
        {
            ...
            var g = {
                ...
                {
                    var value = g.inputText.val() == "" ? "0" : g.inputText.val();
                ...
                {
                    var value = g.inputText.val() == "" ? "00:00" : g.inputText.val();
            ...
            g.link = $('<div class="l-trigger-spinner"><div class="l-spinner-up"><div class="l-spinner-icon"></div></div><div class="l-spinner-split"></div><div class="l-spinner-down"><div class="l-spinner-icon"></div></div></div>');
            g.wrapper = g.inputText.wrap('<div class="l-text-spinner"></div>').parent();
            ...
            if (!g.inputText.hasClass("l-text-spinner-field")) g.inputText.addClass("l-text-spinner-field");
            ...
            g.inputText.change(function()
            {
                ...
                //add by su  当内容为空的时候不做重置
                if( value == "" ) {
                    g.inputText.trigger("SPINNER_CLEAR");
                    return ;
                }
            ...
            {
                g.wrapper.removeClass("l-text-spinner-focus");
            }).focus(function()
            {
                g.wrapper.addClass("l-text-spinner-focus");
            });
            g.wrapper.hover(function()
            {
                g.wrapper.addClass("l-text-spinner-over");
            }, function()
            {
                g.wrapper.removeClass("l-text-spinner-over");
            });

            g.inputText.bind("SPINNER_CLEAR",function(){
                 $(this).attr("value","");
            });
