 ...
 * http://t.wits.sg
 *
 * @update: 添加了切换风格的功能，两种可以选择（原生或者新添加的） author:宋士杰  sjsong01@wisedu.com   2013-07-22
	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'default/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'default/images/progressbg_red.gif',
									30: 'default/images/progressbg_orange.gif',
									70: 'default/images/progressbg_green.gif'
								},
			...
			this.construct = function(arg1, arg2) {
				...
				return this.each(function(child) {
					...
					if (argvalue != null && this.bar != null && this.config != null) {
                        ...
                        $text.css({'line-height':config.height+"px",'display':'block'});
                        if(config.isPic){
