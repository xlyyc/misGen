if (!wof.customWindow.PageFormSelector) {
	wof.customWindow.PageFormSelector = {
        ...
        getPageFormList : function(){
            //var json = JSON.parse(getPageFormList());
            var json = [
                {"id":"id1","name":"name1","caption":"caption1"},
                {"id":"id2","name":"name2","caption":"caption2"},
                {"id":"id3","name":"name3","caption":"caption3"},
                {"id":"id4","name":"name4","caption":"caption4"},
                {"id":"id5","name":"name5","caption":"caption5"}
            ];
            return json;
        }
