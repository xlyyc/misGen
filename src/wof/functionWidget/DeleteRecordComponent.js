        ...
        if(this._initFlag==null){
            ...
            this.getDomInstance().mousedown(function(event){
                ...
                timeFn = setTimeout(function(){
                    _this.sendMessage('wof.functionWidget.DeleteRecordComponent_mousedown');
                    _this.sendMessage('wof.functionWidget.DeleteRecordComponent_active');
                },250);
            });
            ...
            this.getDomInstance().dblclick(function(event){
                event.stopPropagation();
                clearTimeout(timeFn);
                _this.sendMessage('wof.functionWidget.DeleteRecordComponent_dblclick');
                _this.sendMessage('wof.functionWidget.DeleteRecordComponent_active');
            });
